                  ...
                  <div className="col-sm-6 col-md-5 ">
                     <div className="footer-bottom-follow">
                        ...
                        <ul className="social-list social-list--sm  ">
                           <li><Link to="/"><i className="mdicon mdicon-facebook"></i></Link></li>
                           <li><Link to="/"><i className="mdicon mdicon-twitter"></i></Link></li>
                           <li><Link to="/"><i className="mdicon mdicon-youtube"></i></Link></li>
                        </ul>
                     </div>
                  </div>
               </div>
