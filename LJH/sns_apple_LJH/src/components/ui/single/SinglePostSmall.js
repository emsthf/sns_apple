        ...
        <div className="posts-navigation__prev">
          <article className="post post--vertical ">
            <div className="post__thumb">
              <a className="navigation-button" to="single-1.html">
                <div
                  className="background-img"
                  style={{ background: `url('../.${prevData.titleImage}')` }}
                ></div>
              </a>
              <div className="post__meta ">
                <Link to={`/single/${id - 1}`}>
                  ...
                  >
                    <path
                      id="slider-prev"
                      data-name="Slider Prev"
                      className="slider_arrow_path"
                      d="M8.158,0.007L8.835,0.685,1.5,8.019H32V8.979H1.5l7.338,7.334-0.677.679L0,8.839V8.16Z"
                    ></path>
                  </svg>
                  Prev
                </Link>
              ...
              <div className="post__text-wrap">
                <div className="post__text-inner">
                  <h3 className="post__title">
                    <Link To="single-1.html">{prevData.postTitle}</Link>
                  </h3>
                </div>
              </div>
            </div>
          ...
          <article className="post post--vertical ">
            <div className="post__thumb">
              <Link className="navigation-button" to="single-1.html">
                <div
                  className="background-img"
                  style={{ background: `url('../.${nexData.titleImage}')` }}
                ></div>
              </Link>
              <div className="post__meta ">
                <Link to={`/single/${parseInt(id) + 1}`}>
                  ...
                  >
                    <path
                      id="slider-next"
                      data-name="Slider Next"
                      className="slider_arrow_path"
                      d="M23.842,0.007l-0.677.678L30.5,8.019H0V8.979H30.5l-7.338,7.334,0.677,0.679L32,8.839V8.16Z"
                    ></path>
                  </svg>
                </Link>
              </div>
            ...
            <div className="post__text inverse-text">
              <div className="post__text-wrap">
                <div className="post__text-inner">
                  <h3 className="post__title">
                    <Link to="single-1.html">{nexData.postTitle}</Link>
                  </h3>
                </div>
              </div>
            </div>
